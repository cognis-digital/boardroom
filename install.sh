#!/usr/bin/env sh
# Universal installer for boardroom. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/boardroom.git"
echo "Installing boardroom ..."
