"""BOARDROOM command-line interface."""
from __future__ import annotations
import argparse, sys
from boardroom.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="boardroom", description="BOARDROOM — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from boardroom.mcp_server import serve
        return serve()
    if args.cmd == "scan":
