"""BOARDROOM core — Investor-update and KPI one-pager generator from your metrics."""
...
RULES = [
    ("BOA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("BOA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("BOA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
